...
--Functions
'train_diffusionMap_grid_BSD_kerkmeans.py' is the function for pre-train spec-diff-net with LR kernel matching loss
'train_diffusionMap_grid_BSD_kerkmeans_full.py' is the function for train spec-diff-net using full training loss.
...
'BSD_diffMap164000_clus_BSD500_trainval_full.pth' is the fully trained network using 'train_diffusionMap_grid_BSD_kerkmeans_full.py'
...
In 'eval_diffusionMap_grid_kerkmeans.py', please change FOLDER_PSEUDO_Label to your favarate path.
