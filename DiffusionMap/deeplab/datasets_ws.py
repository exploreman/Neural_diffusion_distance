...
class VOCDataSet(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        mat_file = scipy.io.loadmat(datafiles["data_file"])
        ...
        image = mat_file['im']
        simi = mat_file['pred']
        #label = mat_file['segResult']
        label = mat_file['lamap_sp']
        segMask = mat_file['labels']
        coor = mat_file['coor']
        ...
        return image.copy(), simi.copy(), label.copy(), segMask.copy(), coor.copy()
