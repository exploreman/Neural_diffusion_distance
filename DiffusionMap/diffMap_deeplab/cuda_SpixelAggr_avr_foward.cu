...
void __global__ feat_aggr_avr_ker(float *res, const float *d_Feats, const float *d_SegsIdx, 
                 ...
                 int nrhs, mxArray const *prhs[])
{
    ...
    mxGPUArray const *Feats, *SegsIdx, *CoorIdx;
    float const *d_Feats, *d_SegsIdx;
    ...
    /*CoorIdx = mxGPUCreateFromMxArray(prhs[3]);*/
    double* p_nsegs = mxGetPr(prhs[2]);
    ...
    /*d_CoorIdx = (float const *)(mxGPUGetDataReadOnly(CoorIdx));*/
    ...
    int nSegs = p_nsegs[0]; /* number of segments */
   ...
   /*printf("%d %d %d\n", nPixels, nSegs, dFeats);*/
    ...
    feat_aggr_avr_ker<<<blocksPerGrid, threadsPerBlock>>>(d_res, d_Feats, d_SegsIdx, nSegs, nPixels, dFeats);
